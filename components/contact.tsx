...
export default function Contact() {
  ...
  return (
    <section className="py-20 px-4 bg-zinc-800 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-64 h-64 bg-lime-500/10 rounded-full -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-lime-500/10 rounded-full translate-x-1/3 translate-y-1/3"></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <Input
                  ...
                  required
                  className="bg-zinc-800 border-zinc-700 focus:border-lime-500 text-white"
                />
              </div>
              ...
              <div>
                <Textarea
                  ...
                  onChange={handleChange}
                  required
                  className="bg-zinc-800 border-zinc-700 focus:border-lime-500 text-white min-h-[150px]"
                />
              </div>
