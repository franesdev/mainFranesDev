...
export default function CourseContact() {
  ...
  const content = {
    en: {
      title: "Get In Touch",
      subtitle: "Questions? Want to collaborate or share feedback?",
      ...
      newsletter_cta: "Join the Thursday Ritual",
      newsletter_description: "Every Thursday: my thinking mistake that week + weekly logic challenge. Plus access to a community of people who think differently. No spam. Just the real process.",
      newsletter_button: "Subscribe — It's Free",
      email_label: "Email",
      email_value: "franesdev@gmail.com",
    ...
    es: {
      ...
      subtitle: "¿Preguntas? ¿Quieres colaborar o compartir feedback?",
      ...
      newsletter_cta: "Únete al Ritual de los Jueves",
      newsletter_description: "Cada jueves: mi error de pensamiento de esa semana + reto semanal de lógica. Más acceso a una comunidad de gente que piensa diferente. Sin spam. Solo el proceso real.",
      newsletter_button: "Suscríbete — Es Gratis",
      email_label: "Email",
      email_value: "franesdev@gmail.com",
      whatsapp_label: "WhatsApp",
      whatsapp_value: "+593 99 782 5115",
