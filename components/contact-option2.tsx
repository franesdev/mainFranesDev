...
export default function Contact() {
  ...
  return (
    <section className="py-20 px-4 bg-black relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-lime-500/5 rounded-full translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-lime-500/5 rounded-full -translate-x-1/2 translate-y-1/2"></div>
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        >
          ...
          <p className="mt-4 text-gray-300">{content[language].subtitle}</p>
        </motion.div>
          ...
          <CardContent className="p-0">
            <div className="grid md:grid-cols-2">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.8 }}
                className="p-8 bg-gradient-to-br from-lime-500/20 to-transparent"
              >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <Textarea
                        ...
                        onChange={handleChange}
                        required
                        className="bg-gray-800/50 border-gray-700 focus:border-lime-500 text-white min-h-[150px]"
                      />
                    </div>
